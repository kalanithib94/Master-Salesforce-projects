GPTfy Skill Package: Get Product Details
================================

API name : fetch_product_details
Category : Products & Price Books
Apex     : ProductAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = fetch_product_details
...
- Apex is shared per object. Deploying ProductAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "fetch_product_details" prompt record.
...
Skill summary
-------------
Load product code, family, and description for configuration.
