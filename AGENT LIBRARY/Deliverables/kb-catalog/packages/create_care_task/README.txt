GPTfy Skill Package: Create Care Task
================================

API name : create_care_task
Category : Industry Clouds
Apex     : IndustryAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = create_care_task
...
- Apex is shared per object. Deploying IndustryAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "create_care_task" prompt record.
...
Skill summary
-------------
Add a care-plan task for clinical or care-team follow-up.
