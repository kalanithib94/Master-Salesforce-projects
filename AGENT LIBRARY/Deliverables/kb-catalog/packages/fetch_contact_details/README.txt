GPTfy Skill Package: Get Contact Details
================================

API name : fetch_contact_details
Category : Contacts
Apex     : ContactAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = fetch_contact_details
...
- Apex is shared per object. Deploying ContactAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "fetch_contact_details" prompt record.
...
Skill summary
-------------
Load contact profile, title, and account link for outreach or updates.
