GPTfy Skill Package: Update CPQ Quote Line
================================

API name : update_cpq_quote_line
Category : CPQ
Apex     : CpqAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = update_cpq_quote_line
...
- Apex is shared per object. Deploying CpqAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "update_cpq_quote_line" prompt record.
...
Skill summary
-------------
Change quantity, options, or pricing on a CPQ line.
