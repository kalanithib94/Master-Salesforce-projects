...
- Apex is shared per object. Deploying ActivityAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "update_task" prompt record.
...
Skill summary
-------------
Reschedule, reassign, or edit an existing to-do.
