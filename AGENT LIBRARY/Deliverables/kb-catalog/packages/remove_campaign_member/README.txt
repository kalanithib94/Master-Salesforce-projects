GPTfy Skill Package: Remove Campaign Member
================================

API name : remove_campaign_member
Category : Campaigns
Apex     : CampaignAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = remove_campaign_member
...
- Apex is shared per object. Deploying CampaignAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "remove_campaign_member" prompt record.
...
Skill summary
-------------
Take a lead or contact off a campaign membership.
