GPTfy Skill Package: Convert Lead
================================

API name : convert_lead
Category : Leads
Apex     : LeadAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = convert_lead
...
- Apex is shared per object. Deploying LeadAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "convert_lead" prompt record.
...
Skill summary
-------------
Turn a qualified lead into account, contact, and optional opportunity.
