GPTfy Skill Package: Update Case
================================

API name : update_case_fields
Category : Cases
Apex     : CaseAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = update_case_fields
...
- Apex is shared per object. Deploying CaseAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "update_case_fields" prompt record.
...
Skill summary
-------------
Change status, priority, owner, or other case fields mid-work.
