GPTfy Skill Package: Run a GPTfy prompt
================================

API name : run_internal_prompt
Category : Platform & Insights
Apex     : UtilityAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = run_internal_prompt
...
- Apex is shared per object. Deploying UtilityAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "run_internal_prompt" prompt record.
...
Skill summary
-------------
Generate a 360, summary, meeting prep, or draft from record data.
