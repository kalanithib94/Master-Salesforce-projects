GPTfy Skill Package: Update Asset
================================

API name : update_asset_fields
Category : Service Cloud
Apex     : ServiceAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = update_asset_fields
...
- Apex is shared per object. Deploying ServiceAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "update_asset_fields" prompt record.
...
Skill summary
-------------
Update asset status, location, or warranty-related fields.
