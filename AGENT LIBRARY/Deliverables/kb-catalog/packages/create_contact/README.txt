...
- Apex is shared per object. Deploying ContactAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "create_contact" prompt record.
...
Skill summary
-------------
Add a person to Salesforce, usually under an existing account.
