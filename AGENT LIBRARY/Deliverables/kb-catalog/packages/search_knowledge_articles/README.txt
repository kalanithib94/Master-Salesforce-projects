GPTfy Skill Package: Search Knowledge Articles
================================

API name : search_knowledge_articles
Category : Service Cloud
Apex     : UtilityAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = search_knowledge_articles
...
- Apex is shared per object. Deploying UtilityAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "search_knowledge_articles" prompt record.
...
Skill summary
-------------
Find KB articles that may answer the customer's question.
