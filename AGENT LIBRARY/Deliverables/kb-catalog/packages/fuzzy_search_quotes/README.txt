GPTfy Skill Package: Search Quotes
================================

API name : fuzzy_search_quotes
Category : Quotes
Apex     : QuoteAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = fuzzy_search_quotes
...
- Apex is shared per object. Deploying QuoteAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "fuzzy_search_quotes" prompt record.
...
Skill summary
-------------
Find a quote by name when the quote number is unknown.
