GPTfy Skill Package: Add Opportunity Contact Role
================================

API name : add_opportunity_contact_role
Category : Opportunities
Apex     : OpportunityAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = add_opportunity_contact_role
...
- Apex is shared per object. Deploying OpportunityAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "add_opportunity_contact_role" prompt record.
...
Skill summary
-------------
Link a contact to the deal with a role such as Decision Maker.
