GPTfy Skill Package: Get Stale Opportunities
================================

API name : fetch_stale_opportunities
Category : Opportunities
Apex     : UtilityAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = fetch_stale_opportunities
...
- Apex is shared per object. Deploying UtilityAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "fetch_stale_opportunities" prompt record.
...
Skill summary
-------------
Surface deals with little recent activity that may need attention.
