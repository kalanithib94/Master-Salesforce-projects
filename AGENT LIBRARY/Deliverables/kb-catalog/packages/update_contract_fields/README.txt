GPTfy Skill Package: Update Contract
================================

API name : update_contract_fields
Category : Contracts
Apex     : ContractAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = update_contract_fields
...
- Apex is shared per object. Deploying ContractAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "update_contract_fields" prompt record.
...
Skill summary
-------------
Update contract status, dates, or terms after review.
