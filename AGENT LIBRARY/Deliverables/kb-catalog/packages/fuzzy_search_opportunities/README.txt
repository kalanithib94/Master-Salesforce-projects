GPTfy Skill Package: Search Opportunities
================================

API name : fuzzy_search_opportunities
Category : Opportunities
Apex     : OpportunityAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = fuzzy_search_opportunities
...
- Apex is shared per object. Deploying OpportunityAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "fuzzy_search_opportunities" prompt record.
...
Skill summary
-------------
Find a deal by name when the user cannot provide the Id.
