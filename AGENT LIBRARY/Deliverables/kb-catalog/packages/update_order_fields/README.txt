GPTfy Skill Package: Update Order
================================

API name : update_order_fields
Category : Orders & Subscriptions
Apex     : OrderAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = update_order_fields
...
- Apex is shared per object. Deploying OrderAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "update_order_fields" prompt record.
...
Skill summary
-------------
Update order status or header fields during fulfillment.
