GPTfy Skill Package: Get Opportunity Details
================================

API name : fetch_opportunity_details
Category : Opportunities
Apex     : OpportunityAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = fetch_opportunity_details
...
- Apex is shared per object. Deploying OpportunityAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "fetch_opportunity_details" prompt record.
...
Skill summary
-------------
Load stage, amount, close date, and deal context for review.
