GPTfy Skill Package: Update Work Order
================================

API name : update_work_order_fields
Category : Field Service
Apex     : FieldServiceAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = update_work_order_fields
...
- Apex is shared per object. Deploying FieldServiceAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "update_work_order_fields" prompt record.
...
Skill summary
-------------
Change work order status, priority, or schedule fields.
