GPTfy Skill Package: Update Contact
================================

API name : update_contact_fields
Category : Contacts
Apex     : ContactAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = update_contact_fields
...
- Apex is shared per object. Deploying ContactAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "update_contact_fields" prompt record.
...
Skill summary
-------------
Correct email, phone, title, or other contact details after confirmation.
