GPTfy Skill Package: Update CPQ Quote
================================

API name : update_cpq_quote_fields
Category : CPQ
Apex     : CpqAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = update_cpq_quote_fields
...
- Apex is shared per object. Deploying CpqAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "update_cpq_quote_fields" prompt record.
...
Skill summary
-------------
Edit CPQ quote status or header fields before calculation.
