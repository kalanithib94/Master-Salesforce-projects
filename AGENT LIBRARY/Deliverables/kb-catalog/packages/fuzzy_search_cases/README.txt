GPTfy Skill Package: Search Cases
================================

API name : fuzzy_search_cases
Category : Cases
Apex     : CaseAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = fuzzy_search_cases
...
- Apex is shared per object. Deploying CaseAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "fuzzy_search_cases" prompt record.
...
Skill summary
-------------
Find a ticket by subject or case number from chat.
