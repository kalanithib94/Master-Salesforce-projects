GPTfy Skill Package: Search Products
================================

API name : fuzzy_search_products
Category : Products & Price Books
Apex     : ProductAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = fuzzy_search_products
...
- Apex is shared per object. Deploying ProductAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "fuzzy_search_products" prompt record.
...
Skill summary
-------------
Find a SKU or product name before adding lines to a deal or quote.
