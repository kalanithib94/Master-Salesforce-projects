GPTfy Skill Package: Search Accounts
================================

API name : fuzzy_search_accounts
Category : Accounts
Apex     : AccountAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = fuzzy_search_accounts
...
- Apex is shared per object. Deploying AccountAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "fuzzy_search_accounts" prompt record.
...
Skill summary
-------------
Locate a company when the user gives a partial or spoken name.
