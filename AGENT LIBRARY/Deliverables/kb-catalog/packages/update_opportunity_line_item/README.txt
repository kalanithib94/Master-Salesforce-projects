GPTfy Skill Package: Update Opportunity Product
================================

API name : update_opportunity_line_item
Category : Opportunities
Apex     : OpportunityAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = update_opportunity_line_item
...
- Apex is shared per object. Deploying OpportunityAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "update_opportunity_line_item" prompt record.
...
Skill summary
-------------
Adjust quantity, price, or discount on an existing product line.
