...
- Apex is shared per object. Deploying CaseAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "create_case" prompt record.
...
Skill summary
-------------
Open a support ticket linked to the right account or contact.
