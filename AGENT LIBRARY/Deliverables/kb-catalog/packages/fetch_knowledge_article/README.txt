GPTfy Skill Package: Get Knowledge Article
================================

API name : fetch_knowledge_article
Category : Service Cloud
Apex     : UtilityAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = fetch_knowledge_article
...
- Apex is shared per object. Deploying UtilityAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "fetch_knowledge_article" prompt record.
...
Skill summary
-------------
Open the full article body for use in a reply.
