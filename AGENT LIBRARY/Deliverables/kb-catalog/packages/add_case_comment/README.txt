GPTfy Skill Package: Add Case Comment
================================

API name : add_case_comment
Category : Cases
Apex     : CaseAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = add_case_comment
...
- Apex is shared per object. Deploying CaseAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "add_case_comment" prompt record.
...
Skill summary
-------------
Post an internal or public update on the case thread.
