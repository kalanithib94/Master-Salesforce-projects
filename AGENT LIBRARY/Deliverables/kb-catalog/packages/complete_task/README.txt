GPTfy Skill Package: Complete Task
================================

API name : complete_task
Category : Activities & Scheduling
Apex     : ActivityAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = complete_task
...
- Apex is shared per object. Deploying ActivityAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "complete_task" prompt record.
...
Skill summary
-------------
Mark a follow-up done after the work is finished.
