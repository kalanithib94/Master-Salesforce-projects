...
- Apex is shared per object. Deploying OrderAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "create_order" prompt record.
...
Skill summary
-------------
Create an order from account or opportunity context.
