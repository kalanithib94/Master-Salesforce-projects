GPTfy Skill Package: Update Care Plan
================================

API name : update_care_plan_fields
Category : Industry Clouds
Apex     : IndustryAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = update_care_plan_fields
...
- Apex is shared per object. Deploying IndustryAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "update_care_plan_fields" prompt record.
...
Skill summary
-------------
Update care plan status or dates in Health Cloud orgs.
