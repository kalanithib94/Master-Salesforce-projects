GPTfy Skill Package: Add Opportunity Team Member
================================

API name : add_opportunity_team_member
Category : Opportunities
Apex     : OpportunityAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = add_opportunity_team_member
...
- Apex is shared per object. Deploying OpportunityAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "add_opportunity_team_member" prompt record.
...
Skill summary
-------------
Add a colleague to the deal with a team role.
