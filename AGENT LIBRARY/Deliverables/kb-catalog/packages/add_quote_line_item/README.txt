GPTfy Skill Package: Add Quote Line Item
================================

API name : add_quote_line_item
Category : Quotes
Apex     : QuoteAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = add_quote_line_item
...
- Apex is shared per object. Deploying QuoteAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "add_quote_line_item" prompt record.
...
Skill summary
-------------
Add a priced product line to the quote.
