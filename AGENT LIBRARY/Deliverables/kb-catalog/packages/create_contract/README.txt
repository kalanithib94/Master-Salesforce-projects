...
- Apex is shared per object. Deploying ContractAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "create_contract" prompt record.
...
Skill summary
-------------
Create a contract record under the customer account.
