GPTfy Skill Package: Get Lead Details
================================

API name : fetch_lead_details
Category : Leads
Apex     : LeadAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = fetch_lead_details
...
- Apex is shared per object. Deploying LeadAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "fetch_lead_details" prompt record.
...
Skill summary
-------------
Load lead status, source, and company context for follow-up.
