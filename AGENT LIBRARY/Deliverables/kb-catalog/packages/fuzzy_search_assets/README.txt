GPTfy Skill Package: Search Assets
================================

API name : fuzzy_search_assets
Category : Service Cloud
Apex     : ServiceAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = fuzzy_search_assets
...
- Apex is shared per object. Deploying ServiceAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "fuzzy_search_assets" prompt record.
...
Skill summary
-------------
Find installed equipment by name or serial number.
