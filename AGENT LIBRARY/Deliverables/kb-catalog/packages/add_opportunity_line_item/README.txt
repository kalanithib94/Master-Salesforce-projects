GPTfy Skill Package: Add Opportunity Product
================================

API name : add_opportunity_line_item
Category : Opportunities
Apex     : OpportunityAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = add_opportunity_line_item
...
- Apex is shared per object. Deploying OpportunityAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "add_opportunity_line_item" prompt record.
...
Skill summary
-------------
Attach a priced product from the price book to the deal.
