GPTfy Skill Package: Get Care Plan
================================

API name : fetch_care_plan
Category : Industry Clouds
Apex     : IndustryAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = fetch_care_plan
...
- Apex is shared per object. Deploying IndustryAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "fetch_care_plan" prompt record.
...
Skill summary
-------------
Load a Health Cloud care plan and related goals when available.
