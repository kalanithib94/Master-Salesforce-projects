GPTfy Skill Package: Get Order Details
================================

API name : fetch_order_details
Category : Orders & Subscriptions
Apex     : OrderAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = fetch_order_details
...
- Apex is shared per object. Deploying OrderAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "fetch_order_details" prompt record.
...
Skill summary
-------------
Load order status, account, and totals after win or fulfillment.
