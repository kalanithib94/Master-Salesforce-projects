GPTfy Skill Package: Update Campaign
================================

API name : update_campaign_fields
Category : Campaigns
Apex     : CampaignAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = update_campaign_fields
...
- Apex is shared per object. Deploying CampaignAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "update_campaign_fields" prompt record.
...
Skill summary
-------------
Change campaign status, dates, or type after launch planning.
