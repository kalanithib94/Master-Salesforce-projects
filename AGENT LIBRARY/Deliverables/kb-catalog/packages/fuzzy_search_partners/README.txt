GPTfy Skill Package: Search Partner Accounts
================================

API name : fuzzy_search_partners
Category : Partner Management
Apex     : PartnerAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = fuzzy_search_partners
...
2) Deploy Apex (from the unzipped folder):
   ...
   or
   sf project deploy start --manifest package.xml --test-level RunSpecifiedTests --tests AgenticSkillsBaseTest --tests PartnerAgenticSkillsHandlerTest --target-org <alias>
...
NOTES
-----
- Apex is shared per object. Deploying PartnerAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "fuzzy_search_partners" prompt record.
...
Skill summary
-------------
Find partner accounts by name for deal registration or teaming.
