GPTfy Skill Package: Get Opportunity Contact Roles
================================

API name : fetch_opportunity_contact_roles
Category : Opportunities
Apex     : OpportunityAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = fetch_opportunity_contact_roles
...
- Apex is shared per object. Deploying OpportunityAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "fetch_opportunity_contact_roles" prompt record.
...
Skill summary
-------------
See who on the buying committee is linked to the deal.
