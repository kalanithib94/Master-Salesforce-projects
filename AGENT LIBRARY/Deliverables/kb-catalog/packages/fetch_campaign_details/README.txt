GPTfy Skill Package: Get Campaign Details
================================

API name : fetch_campaign_details
Category : Campaigns
Apex     : CampaignAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = fetch_campaign_details
...
- Apex is shared per object. Deploying CampaignAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "fetch_campaign_details" prompt record.
...
Skill summary
-------------
Load campaign dates, type, status, and response counts.
