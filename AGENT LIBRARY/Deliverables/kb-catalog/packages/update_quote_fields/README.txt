GPTfy Skill Package: Update Quote
================================

API name : update_quote_fields
Category : Quotes
Apex     : QuoteAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = update_quote_fields
...
- Apex is shared per object. Deploying QuoteAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "update_quote_fields" prompt record.
...
Skill summary
-------------
Change quote status, expiration, or header fields.
