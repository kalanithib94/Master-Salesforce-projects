GPTfy Skill Package: Add Case Team Member
================================

API name : add_case_team_member
Category : Cases
Apex     : CaseAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = add_case_team_member
...
- Apex is shared per object. Deploying CaseAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "add_case_team_member" prompt record.
...
Skill summary
-------------
Bring another agent or specialist onto the case team.
