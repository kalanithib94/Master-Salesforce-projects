GPTfy Skill Package: Create Opportunity
================================

API name : create_opportunity
Category : Opportunities
Apex     : OpportunityAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = create_opportunity
...
- Apex is shared per object. Deploying OpportunityAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "create_opportunity" prompt record.
...
Skill summary
-------------
Start a new deal with account, stage, and close date confirmed.
