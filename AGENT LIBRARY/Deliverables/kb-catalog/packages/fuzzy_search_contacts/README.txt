GPTfy Skill Package: Search Contacts
================================

API name : fuzzy_search_contacts
Category : Contacts
Apex     : ContactAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = fuzzy_search_contacts
...
- Apex is shared per object. Deploying ContactAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "fuzzy_search_contacts" prompt record.
...
Skill summary
-------------
Find a person by name or email when the Salesforce Id is unknown.
