GPTfy Skill Package: Add Campaign Member
================================

API name : add_campaign_member
Category : Campaigns
Apex     : CampaignAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = add_campaign_member
...
- Apex is shared per object. Deploying CampaignAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "add_campaign_member" prompt record.
...
Skill summary
-------------
Enroll a lead or contact into the campaign.
