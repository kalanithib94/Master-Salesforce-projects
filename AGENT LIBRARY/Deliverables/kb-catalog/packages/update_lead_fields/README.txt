GPTfy Skill Package: Update Lead
================================

API name : update_lead_fields
Category : Leads
Apex     : LeadAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = update_lead_fields
...
- Apex is shared per object. Deploying LeadAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "update_lead_fields" prompt record.
...
Skill summary
-------------
Update lead status, score, or contact info during qualification.
