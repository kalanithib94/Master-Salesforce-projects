GPTfy Skill Package: Get Financial Account
================================

API name : fetch_financial_account
Category : Industry Clouds
Apex     : IndustryAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = fetch_financial_account
...
- Apex is shared per object. Deploying IndustryAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "fetch_financial_account" prompt record.
...
Skill summary
-------------
Load FSC financial account balances and ownership when licensed.
