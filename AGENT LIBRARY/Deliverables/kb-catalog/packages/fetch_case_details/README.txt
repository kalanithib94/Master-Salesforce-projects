GPTfy Skill Package: Get Case Details
================================

API name : fetch_case_details
Category : Cases
Apex     : CaseAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = fetch_case_details
...
- Apex is shared per object. Deploying CaseAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "fetch_case_details" prompt record.
...
Skill summary
-------------
Load case status, priority, and customer context for support work.
