GPTfy Skill Package: Create Work Order
================================

API name : create_work_order
Category : Field Service
Apex     : FieldServiceAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = create_work_order
...
- Apex is shared per object. Deploying FieldServiceAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "create_work_order" prompt record.
...
Skill summary
-------------
Open a work order for on-site or remote service.
