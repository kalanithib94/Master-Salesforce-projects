GPTfy Skill Package: Get Campaign Members
================================

API name : fetch_campaign_members
Category : Campaigns
Apex     : CampaignAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = fetch_campaign_members
...
- Apex is shared per object. Deploying CampaignAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "fetch_campaign_members" prompt record.
...
Skill summary
-------------
List who is already on the campaign and their status.
