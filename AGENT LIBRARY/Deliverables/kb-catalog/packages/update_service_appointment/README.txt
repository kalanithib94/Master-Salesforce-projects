GPTfy Skill Package: Update Service Appointment
================================

API name : update_service_appointment
Category : Field Service
Apex     : FieldServiceAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = update_service_appointment
...
- Apex is shared per object. Deploying FieldServiceAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "update_service_appointment" prompt record.
...
Skill summary
-------------
Edit appointment status, time, or assignment details.
