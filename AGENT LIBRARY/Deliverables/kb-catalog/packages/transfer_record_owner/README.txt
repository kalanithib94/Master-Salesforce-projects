GPTfy Skill Package: Transfer Record Owner
================================

API name : transfer_record_owner
Category : Platform & Insights
Apex     : UtilityAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = transfer_record_owner
...
- Apex is shared per object. Deploying UtilityAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "transfer_record_owner" prompt record.
...
Skill summary
-------------
Reassign ownership of a record to another user.
