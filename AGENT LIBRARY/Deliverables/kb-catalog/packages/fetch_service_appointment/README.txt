GPTfy Skill Package: Get Service Appointment
================================

API name : fetch_service_appointment
Category : Field Service
Apex     : FieldServiceAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = fetch_service_appointment
...
- Apex is shared per object. Deploying FieldServiceAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "fetch_service_appointment" prompt record.
...
Skill summary
-------------
Load appointment time window and assigned resource.
