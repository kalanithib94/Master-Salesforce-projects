GPTfy Skill Package: Update Event
================================

API name : update_event
Category : Activities & Scheduling
Apex     : ActivityAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = update_event
...
- Apex is shared per object. Deploying ActivityAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "update_event" prompt record.
...
Skill summary
-------------
Reschedule or edit meeting time, location, or notes.
