GPTfy Skill Package: Get Record Approvals
================================

API name : fetch_record_approvals
Category : Platform & Insights
Apex     : UtilityAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = fetch_record_approvals
...
- Apex is shared per object. Deploying UtilityAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "fetch_record_approvals" prompt record.
...
Skill summary
-------------
See pending approval requests and submitters on a record.
