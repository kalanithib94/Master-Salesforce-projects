GPTfy Skill Package: Clone Opportunity
================================

API name : clone_opportunity
Category : Opportunities
Apex     : OpportunityAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = clone_opportunity
...
- Apex is shared per object. Deploying OpportunityAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "clone_opportunity" prompt record.
...
Skill summary
-------------
Duplicate a deal to start a related or renewal opportunity faster.
