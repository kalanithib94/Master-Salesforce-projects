GPTfy Skill Package: Get Asset Details
================================

API name : fetch_asset_details
Category : Service Cloud
Apex     : ServiceAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = fetch_asset_details
...
- Apex is shared per object. Deploying ServiceAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "fetch_asset_details" prompt record.
...
Skill summary
-------------
Load asset status, account, and product information.
