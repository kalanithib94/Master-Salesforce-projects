GPTfy Skill Package: Get Picklist Values
================================

API name : fetch_picklist_values
Category : Platform & Insights
Apex     : UtilityAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = fetch_picklist_values
...
- Apex is shared per object. Deploying UtilityAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "fetch_picklist_values" prompt record.
...
Skill summary
-------------
List valid choices for a field before setting a picklist value.
