GPTfy Skill Package: Create Campaign
================================

API name : create_campaign
Category : Campaigns
Apex     : CampaignAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = create_campaign
...
- Apex is shared per object. Deploying CampaignAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "create_campaign" prompt record.
...
Skill summary
-------------
Set up a new marketing campaign with name and schedule.
