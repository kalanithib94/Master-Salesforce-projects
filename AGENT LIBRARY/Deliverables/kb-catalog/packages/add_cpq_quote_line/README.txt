GPTfy Skill Package: Add CPQ Quote Line
================================

API name : add_cpq_quote_line
Category : CPQ
Apex     : CpqAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = add_cpq_quote_line
...
- Apex is shared per object. Deploying CpqAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "add_cpq_quote_line" prompt record.
...
Skill summary
-------------
Add a CPQ product or bundle line to the quote.
