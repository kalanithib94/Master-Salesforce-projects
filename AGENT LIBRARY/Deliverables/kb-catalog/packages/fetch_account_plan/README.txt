GPTfy Skill Package: Get Account Plan
================================

API name : fetch_account_plan
Category : Accounts
Apex     : AccountAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = fetch_account_plan
...
- Apex is shared per object. Deploying AccountAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "fetch_account_plan" prompt record.
...
Skill summary
-------------
Load strategic plan and objectives for the account when the object exists.
