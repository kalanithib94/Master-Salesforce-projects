GPTfy Skill Package: Get Opportunity Partners
================================

API name : fetch_opportunity_partners
Category : Opportunities
Apex     : OpportunityAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = fetch_opportunity_partners
...
- Apex is shared per object. Deploying OpportunityAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "fetch_opportunity_partners" prompt record.
...
Skill summary
-------------
List partners already tied to the opportunity.
