GPTfy Skill Package: Close Case
================================

API name : close_case
Category : Cases
Apex     : CaseAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = close_case
...
- Apex is shared per object. Deploying CaseAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "close_case" prompt record.
...
Skill summary
-------------
Resolve and close a ticket after the customer issue is handled.
