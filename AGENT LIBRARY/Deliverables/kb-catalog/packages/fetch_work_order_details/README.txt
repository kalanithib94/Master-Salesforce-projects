GPTfy Skill Package: Get Work Order Details
================================

API name : fetch_work_order_details
Category : Field Service
Apex     : FieldServiceAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = fetch_work_order_details
...
- Apex is shared per object. Deploying FieldServiceAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "fetch_work_order_details" prompt record.
...
Skill summary
-------------
Load field service work order status and related customer data.
