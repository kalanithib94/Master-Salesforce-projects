GPTfy Skill Package: Update Opportunity
================================

API name : update_opportunity_fields
Category : Opportunities
Apex     : OpportunityAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = update_opportunity_fields
...
- Apex is shared per object. Deploying OpportunityAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "update_opportunity_fields" prompt record.
...
Skill summary
-------------
Move stage, change amount or close date, or edit other deal fields.
