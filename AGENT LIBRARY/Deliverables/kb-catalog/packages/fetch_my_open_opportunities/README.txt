GPTfy Skill Package: Get My Open Opportunities
================================

API name : fetch_my_open_opportunities
Category : Opportunities
Apex     : UtilityAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = fetch_my_open_opportunities
...
- Apex is shared per object. Deploying UtilityAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "fetch_my_open_opportunities" prompt record.
...
Skill summary
-------------
Pipeline view of the current user's open deals.
