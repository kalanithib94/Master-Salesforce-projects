GPTfy Skill Package: Get Opportunity Team
================================

API name : fetch_opportunity_team
Category : Opportunities
Apex     : OpportunityAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = fetch_opportunity_team
...
- Apex is shared per object. Deploying OpportunityAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "fetch_opportunity_team" prompt record.
...
Skill summary
-------------
List internal sellers and specialists on the deal team.
