GPTfy Skill Package: Search Campaigns
================================

API name : fuzzy_search_campaigns
Category : Campaigns
Apex     : CampaignAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = fuzzy_search_campaigns
...
- Apex is shared per object. Deploying CampaignAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "fuzzy_search_campaigns" prompt record.
...
Skill summary
-------------
Find a marketing campaign by name for member or status work.
