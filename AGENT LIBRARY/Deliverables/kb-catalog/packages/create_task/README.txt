...
- Apex is shared per object. Deploying ActivityAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "create_task" prompt record.
...
Skill summary
-------------
Schedule a follow-up to-do with due date and owner.
