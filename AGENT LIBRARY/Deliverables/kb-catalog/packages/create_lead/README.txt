...
- Apex is shared per object. Deploying LeadAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "create_lead" prompt record.
...
Skill summary
-------------
Capture a new prospect when there is no matching account yet.
