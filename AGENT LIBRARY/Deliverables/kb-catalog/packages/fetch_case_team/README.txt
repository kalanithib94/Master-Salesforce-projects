GPTfy Skill Package: Get Case Team
================================

API name : fetch_case_team
Category : Cases
Apex     : CaseAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = fetch_case_team
...
- Apex is shared per object. Deploying CaseAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "fetch_case_team" prompt record.
...
Skill summary
-------------
See who is collaborating on the support case.
