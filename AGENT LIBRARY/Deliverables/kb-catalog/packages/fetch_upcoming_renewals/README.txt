GPTfy Skill Package: Get Upcoming Renewals
================================

API name : fetch_upcoming_renewals
Category : Renewals
Apex     : UtilityAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = fetch_upcoming_renewals
...
- Apex is shared per object. Deploying UtilityAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "fetch_upcoming_renewals" prompt record.
...
Skill summary
-------------
Show renewals closing within the next N days for outreach planning.
