GPTfy Skill Package: Get Renewal Opportunities
================================

API name : fetch_renewal_opportunities
Category : Renewals
Apex     : UtilityAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = fetch_renewal_opportunities
...
- Apex is shared per object. Deploying UtilityAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "fetch_renewal_opportunities" prompt record.
...
Skill summary
-------------
List open renewal-type deals for pipeline or CSM review.
