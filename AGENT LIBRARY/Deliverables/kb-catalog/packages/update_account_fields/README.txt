GPTfy Skill Package: Update Account
================================

API name : update_account_fields
Category : Accounts
Apex     : AccountAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = update_account_fields
...
- Apex is shared per object. Deploying AccountAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "update_account_fields" prompt record.
...
Skill summary
-------------
Change industry, address, phone, or other account data the user confirmed.
