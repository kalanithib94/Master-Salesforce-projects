GPTfy Skill Package: Schedule Service Appointment
================================

API name : schedule_service_appointment
Category : Field Service
Apex     : FieldServiceAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = schedule_service_appointment
...
- Apex is shared per object. Deploying FieldServiceAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "schedule_service_appointment" prompt record.
...
Skill summary
-------------
Set or change when a technician visit is booked.
