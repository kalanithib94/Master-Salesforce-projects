GPTfy Skill Package: Add Opportunity Partner
================================

API name : add_opportunity_partner
Category : Opportunities
Apex     : PartnerAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = add_opportunity_partner
...
- Apex is shared per object. Deploying PartnerAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "add_opportunity_partner" prompt record.
...
Skill summary
-------------
Associate a partner account with a deal and role.
