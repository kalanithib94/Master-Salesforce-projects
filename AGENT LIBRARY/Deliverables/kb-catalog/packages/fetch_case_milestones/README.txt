GPTfy Skill Package: Get Case Milestones
================================

API name : fetch_case_milestones
Category : Service Cloud
Apex     : ServiceAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = fetch_case_milestones
...
- Apex is shared per object. Deploying ServiceAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "fetch_case_milestones" prompt record.
...
Skill summary
-------------
Check SLA milestone progress and breach risk on the case.
