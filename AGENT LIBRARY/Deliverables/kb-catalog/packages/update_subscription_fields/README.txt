GPTfy Skill Package: Update Subscription
================================

API name : update_subscription_fields
Category : Orders & Subscriptions
Apex     : OrderAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = update_subscription_fields
...
- Apex is shared per object. Deploying OrderAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "update_subscription_fields" prompt record.
...
Skill summary
-------------
Change subscription quantity, term, or status fields.
