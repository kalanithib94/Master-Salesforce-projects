...
- Apex is shared per object. Deploying QuoteAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "create_quote" prompt record.
...
Skill summary
-------------
Create a standard quote for an opportunity.
