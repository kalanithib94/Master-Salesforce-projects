GPTfy Skill Package: Get Partner Account Details
================================

API name : fetch_partner_account
Category : Partner Management
Apex     : PartnerAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = fetch_partner_account
...
- Apex is shared per object. Deploying PartnerAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "fetch_partner_account" prompt record.
...
Skill summary
-------------
Load partner account profile and relationship details.
