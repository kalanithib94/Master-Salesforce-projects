GPTfy Skill Package: Update Order Product
================================

API name : update_order_item
Category : Orders & Subscriptions
Apex     : OrderAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = update_order_item
...
- Apex is shared per object. Deploying OrderAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "update_order_item" prompt record.
...
Skill summary
-------------
Adjust quantity or price on an order line.
