GPTfy Skill Package: Create Event
================================

API name : create_event
Category : Activities & Scheduling
Apex     : ActivityAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = create_event
...
- Apex is shared per object. Deploying ActivityAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "create_event" prompt record.
...
Skill summary
-------------
Book a meeting on the calendar linked to a person or record.
