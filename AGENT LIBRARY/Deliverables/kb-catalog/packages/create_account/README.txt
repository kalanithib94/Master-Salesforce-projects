...
- Apex is shared per object. Deploying AccountAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "create_account" prompt record.
...
Skill summary
-------------
Open a new company record after the user confirms the name and key fields.
