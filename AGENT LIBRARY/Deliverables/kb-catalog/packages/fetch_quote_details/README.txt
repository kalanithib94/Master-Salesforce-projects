GPTfy Skill Package: Get Quote Details
================================

API name : fetch_quote_details
Category : Quotes
Apex     : QuoteAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = fetch_quote_details
...
- Apex is shared per object. Deploying QuoteAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "fetch_quote_details" prompt record.
...
Skill summary
-------------
Load quote header, status, and totals for review.
