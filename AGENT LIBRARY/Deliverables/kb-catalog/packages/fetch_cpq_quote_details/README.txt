GPTfy Skill Package: Get CPQ Quote Details
================================

API name : fetch_cpq_quote_details
Category : CPQ
Apex     : CpqAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = fetch_cpq_quote_details
...
- Apex is shared per object. Deploying CpqAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "fetch_cpq_quote_details" prompt record.
...
Skill summary
-------------
Load Salesforce CPQ quote header and configuration context.
