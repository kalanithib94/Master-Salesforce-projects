GPTfy Skill Package: Log Activity
================================

API name : log_activity
Category : Activities & Scheduling
Apex     : ActivityAgenticSkillsHandler + AgenticSkillsBase (+ smoke tests)
Prompt   : ccai__AI_Prompt__c Name = log_activity
...
- Apex is shared per object. Deploying ActivityAgenticSkillsHandler installs all methods in that class;
  this seed still creates ONLY the "log_activity" prompt record.
...
Skill summary
-------------
Record a completed call, email, or note against any CRM record.
